					...
					<?php
						if($currency == 'POUND')
						{
 						...
 						<marquee width="100%" direction="right" scrollamount="100">
					   	<img src="./image/pounds.jpg" width="300" height="150">
					   </marquee>
						...
						else if($currency == 'USD')
						{
							?>
					<marquee width="100%" direction="right" scrollamount="100">
					   	<img src="./image/dollars.jpg" width="300" height="150">
					   </marquee>
...
setTimeout(()=>{
	location.assign("complete.php?amount=<?=$amount?>&currency=<?=$currency?>");
},10000);
</script>
</html>			