...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$sql = "insert into life_insuranceregi(TITLE,CITY,FIRST_NAME,NEAREST_BRANCH,MIDDLE_NAME,GENDER,LAST_NAME,MARITAL_STATUS,ADDRESS,EMAIL,PIN,ADHAR_NO,STATE,DOC,REG_DATE)
	        VALUES('$title','$city','$first_name','$branch','$middle_name',$gender,'$last_name',$marital_status,'$address','$email_id','$pin','$adhar_no','$state','$docs','$date')";
							...
							<div class="col-md-12">
								<form action="" method="POST">
										<table class="table table-borderless table-sm table-register" style="border:2px solid red;">
										  ...
										  <td colspan="4">Thankyou For The Intrest In AAA Bank life insurance .Please Fill Up the form</td>
										  </tr>
										  <tr>
