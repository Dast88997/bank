...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$sql = "insert into card_apply(TITLE,CITY,FIRST_NAME,NEAREST_BRANCH,MIDDLE_NAME,GENDER,LAST_NAME,MARITAL_STATUS,ADDRESS,EMAIL,PIN,ADHAR_NO,STATE,DOC,ACCOUNT_NO,STATUS,REG_DATE)
	        VALUES('$title','$city','$first_name','$branch','$middle_name',$gender,'$last_name',$marital_status,'$address','$email_id','$pin','$adhar_no','$state','$docs','$acct_no',0,'$date')";
									...
									<form action="" method="POST">
										...
										<span>city : </span>
											...
											<tr>
											  ...
											  <td><input type="text"  placeholder="account no" name="account_no"></td>
